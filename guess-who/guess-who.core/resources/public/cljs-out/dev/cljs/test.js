...
var G__11314 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11314,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11314;
}
});
...
var len__4730__auto___11319 = arguments.length;
var i__4731__auto___11320 = (0);
while(true){
if((i__4731__auto___11320 < len__4730__auto___11319)){
args__4736__auto__.push((arguments[i__4731__auto___11320]));

var G__11321 = (i__4731__auto___11320 + (1));
i__4731__auto___11320 = G__11321;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11316){
var G__11317 = cljs.core.first.call(null,seq11316);
var seq11316__$1 = cljs.core.next.call(null,seq11316);
var G__11318 = cljs.core.first.call(null,seq11316__$1);
var seq11316__$2 = cljs.core.next.call(null,seq11316__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11317,G__11318,seq11316__$2);
});
...
var map__11323 = m;
var map__11323__$1 = (((((!((map__11323 == null))))?(((((map__11323.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11323.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11323):map__11323);
var file = cljs.core.get.call(null,map__11323__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11323__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11323__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__11323,map__11323__$1,file,line,column){
return (function (p1__11322_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11322_SHARP_));
});})(map__11323,map__11323__$1,file,line,column))
...
var temp__5457__auto___11325 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___11325)){
var message_11326 = temp__5457__auto___11325;
cljs.core.println.call(null,message_11326);
} else {
}
...
var temp__5457__auto___11327 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___11327)){
var message_11328 = temp__5457__auto___11327;
cljs.core.println.call(null,message_11328);
} else {
}
...
var output_dir__$1 = (function (){var G__11329 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__11329,"/"].join('');
} else {
return G__11329;
}
})();
...
var temp__5455__auto__ = (function (){var and__4120__auto__ = typeof exception.stack === 'string';
if(and__4120__auto__){
var G__11331 = exception.stack;
var G__11331__$1 = (((G__11331 == null))?null:clojure.string.split_lines.call(null,G__11331));
var G__11331__$2 = (((G__11331__$1 == null))?null:cljs.core.get.call(null,G__11331__$1,depth));
if((G__11331__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11331__$2);
}
} else {
...
var vec__11332 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11332,(0),null);
var column = cljs.core.nth.call(null,vec__11332,(1),null);
var vec__11335 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11335,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11335,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11335,(2),null);
...
var m__$1 = (function (){var G__11338 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__11342 = (function (){var G__11341 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11341);
} else {
return G__11341;
}
})();
...
return cljs.core.vary_meta.call(null,G__11343,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__11345 = e;
var G__11345__$1 = (((G__11345 instanceof cljs.core.Keyword))?G__11345.fqn:null);
switch (G__11345__$1) {
...
var vec__11347 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11347,(0),null);
var types = vec__11347;
...
return cljs.core.map.call(null,(function (p__11350){
var vec__11351 = p__11350;
var ns = cljs.core.nth.call(null,vec__11351,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11351,(1),null);
return ((function (vec__11351,ns,vars__$1){
return (function (){
...
var G__11354 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__11354__$1 = (((G__11354 instanceof cljs.core.Keyword))?G__11354.fqn:null);
switch (G__11354__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__11354,G__11354__$1,env,once_fixtures,each_fixtures,vec__11351,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__11354,G__11354__$1,env,once_fixtures,each_fixtures,vec__11351,ns,vars__$1){
return (function (){
var seq__11355 = cljs.core.seq.call(null,vars__$1);
var chunk__11356 = null;
var count__11357 = (0);
var i__11358 = (0);
while(true){
if((i__11358 < count__11357)){
var v = cljs.core._nth.call(null,chunk__11356,i__11358);
var temp__5457__auto___11360 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___11360)){
var t_11361 = temp__5457__auto___11360;
each_fixture_fn.call(null,((function (seq__11355,chunk__11356,count__11357,i__11358,t_11361,temp__5457__auto___11360,v,each_fixture_fn,G__11354,G__11354__$1,env,once_fixtures,each_fixtures,vec__11351,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11361)));
});})(seq__11355,chunk__11356,count__11357,i__11358,t_11361,temp__5457__auto___11360,v,each_fixture_fn,G__11354,G__11354__$1,env,once_fixtures,each_fixtures,vec__11351,ns,vars__$1))
);
} else {
}


var G__11362 = seq__11355;
var G__11363 = chunk__11356;
var G__11364 = count__11357;
var G__11365 = (i__11358 + (1));
seq__11355 = G__11362;
chunk__11356 = G__11363;
count__11357 = G__11364;
i__11358 = G__11365;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__11355);
if(temp__5457__auto__){
var seq__11355__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11355__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__11355__$1);
var G__11366 = cljs.core.chunk_rest.call(null,seq__11355__$1);
var G__11367 = c__4550__auto__;
var G__11368 = cljs.core.count.call(null,c__4550__auto__);
var G__11369 = (0);
seq__11355 = G__11366;
chunk__11356 = G__11367;
count__11357 = G__11368;
i__11358 = G__11369;
continue;
} else {
var v = cljs.core.first.call(null,seq__11355__$1);
var temp__5457__auto___11370__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___11370__$1)){
var t_11371 = temp__5457__auto___11370__$1;
each_fixture_fn.call(null,((function (seq__11355,chunk__11356,count__11357,i__11358,t_11371,temp__5457__auto___11370__$1,v,seq__11355__$1,temp__5457__auto__,each_fixture_fn,G__11354,G__11354__$1,env,once_fixtures,each_fixtures,vec__11351,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11371)));
});})(seq__11355,chunk__11356,count__11357,i__11358,t_11371,temp__5457__auto___11370__$1,v,seq__11355__$1,temp__5457__auto__,each_fixture_fn,G__11354,G__11354__$1,env,once_fixtures,each_fixtures,vec__11351,ns,vars__$1))
);
} else {
}


var G__11372 = cljs.core.next.call(null,seq__11355__$1);
var G__11373 = null;
var G__11374 = (0);
var G__11375 = (0);
seq__11355 = G__11372;
chunk__11356 = G__11373;
count__11357 = G__11374;
i__11358 = G__11375;
continue;
}
} else {
...
});})(each_fixture_fn,G__11354,G__11354__$1,env,once_fixtures,each_fixtures,vec__11351,ns,vars__$1))
);
});})(each_fixture_fn,G__11354,G__11354__$1,env,once_fixtures,each_fixtures,vec__11351,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11354__$1)].join('')));

}
})());
});
;})(vec__11351,ns,vars__$1))
