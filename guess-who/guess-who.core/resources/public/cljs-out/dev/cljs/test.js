...
var G__12250 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__12250,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__12250;
}
});
...
var len__4730__auto___12255 = arguments.length;
var i__4731__auto___12256 = (0);
while(true){
if((i__4731__auto___12256 < len__4730__auto___12255)){
args__4736__auto__.push((arguments[i__4731__auto___12256]));

var G__12257 = (i__4731__auto___12256 + (1));
i__4731__auto___12256 = G__12257;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq12252){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12253,G__12254,seq12252__$2);
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__12259,map__12259__$1,file,line,column){
return (function (p1__12258_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__12258_SHARP_));
});})(map__12259,map__12259__$1,file,line,column))
...
var temp__5457__auto___12261 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___12261)){
var message_12262 = temp__5457__auto___12261;
cljs.core.println.call(null,message_12262);
} else {
}
...
var temp__5457__auto___12263 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___12263)){
var message_12264 = temp__5457__auto___12263;
cljs.core.println.call(null,message_12264);
} else {
}
...
var output_dir__$1 = (function (){var G__12265 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__12265,"/"].join('');
} else {
return G__12265;
}
})();
...
var G__12267 = exception.stack;
var G__12267__$1 = (((G__12267 == null))?null:clojure.string.split_lines.call(null,G__12267));
var G__12267__$2 = (((G__12267__$1 == null))?null:cljs.core.get.call(null,G__12267__$1,depth));
if((G__12267__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__12267__$2);
}
} else {
...
var vec__12268 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__12268,(0),null);
var column = cljs.core.nth.call(null,vec__12268,(1),null);
var vec__12271 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__12271,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__12271,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__12271,(2),null);
...
var m__$1 = (function (){var G__12274 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__12274__$1 = (((G__12274 instanceof cljs.core.Keyword))?G__12274.fqn:null);
switch (G__12274__$1) {
case "fail":
...
var G__12278 = (function (){var G__12277 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__12277);
} else {
return G__12277;
}
})();
...
return cljs.core.vary_meta.call(null,G__12279,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e12280){var e = e12280;
var G__12281 = e;
var G__12281__$1 = (((G__12281 instanceof cljs.core.Keyword))?G__12281.fqn:null);
switch (G__12281__$1) {
...
var vec__12283 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__12283,(0),null);
var types = vec__12283;
...
return cljs.core.map.call(null,(function (p__12286){
var vec__12287 = p__12286;
var ns = cljs.core.nth.call(null,vec__12287,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__12287,(1),null);
return ((function (vec__12287,ns,vars__$1){
return (function (){
...
var G__12290 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__12290__$1 = (((G__12290 instanceof cljs.core.Keyword))?G__12290.fqn:null);
switch (G__12290__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__12290,G__12290__$1,env,once_fixtures,each_fixtures,vec__12287,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__12290,G__12290__$1,env,once_fixtures,each_fixtures,vec__12287,ns,vars__$1){
return (function (){
var seq__12291 = cljs.core.seq.call(null,vars__$1);
var chunk__12292 = null;
var count__12293 = (0);
var i__12294 = (0);
while(true){
if((i__12294 < count__12293)){
var v = cljs.core._nth.call(null,chunk__12292,i__12294);
var temp__5457__auto___12296 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___12296)){
var t_12297 = temp__5457__auto___12296;
each_fixture_fn.call(null,((function (seq__12291,chunk__12292,count__12293,i__12294,t_12297,temp__5457__auto___12296,v,each_fixture_fn,G__12290,G__12290__$1,env,once_fixtures,each_fixtures,vec__12287,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12297)));
});})(seq__12291,chunk__12292,count__12293,i__12294,t_12297,temp__5457__auto___12296,v,each_fixture_fn,G__12290,G__12290__$1,env,once_fixtures,each_fixtures,vec__12287,ns,vars__$1))
);
} else {
}


var G__12298 = seq__12291;
var G__12299 = chunk__12292;
var G__12300 = count__12293;
var G__12301 = (i__12294 + (1));
seq__12291 = G__12298;
chunk__12292 = G__12299;
count__12293 = G__12300;
i__12294 = G__12301;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__12291);
if(temp__5457__auto__){
var seq__12291__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__12291__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__12291__$1);
var G__12302 = cljs.core.chunk_rest.call(null,seq__12291__$1);
var G__12303 = c__4550__auto__;
var G__12304 = cljs.core.count.call(null,c__4550__auto__);
var G__12305 = (0);
seq__12291 = G__12302;
chunk__12292 = G__12303;
count__12293 = G__12304;
i__12294 = G__12305;
continue;
} else {
var v = cljs.core.first.call(null,seq__12291__$1);
var temp__5457__auto___12306__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___12306__$1)){
var t_12307 = temp__5457__auto___12306__$1;
each_fixture_fn.call(null,((function (seq__12291,chunk__12292,count__12293,i__12294,t_12307,temp__5457__auto___12306__$1,v,seq__12291__$1,temp__5457__auto__,each_fixture_fn,G__12290,G__12290__$1,env,once_fixtures,each_fixtures,vec__12287,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12307)));
});})(seq__12291,chunk__12292,count__12293,i__12294,t_12307,temp__5457__auto___12306__$1,v,seq__12291__$1,temp__5457__auto__,each_fixture_fn,G__12290,G__12290__$1,env,once_fixtures,each_fixtures,vec__12287,ns,vars__$1))
);
} else {
}


var G__12308 = cljs.core.next.call(null,seq__12291__$1);
var G__12309 = null;
var G__12310 = (0);
var G__12311 = (0);
seq__12291 = G__12308;
chunk__12292 = G__12309;
count__12293 = G__12310;
i__12294 = G__12311;
continue;
}
} else {
...
});})(each_fixture_fn,G__12290,G__12290__$1,env,once_fixtures,each_fixtures,vec__12287,ns,vars__$1))
);
});})(each_fixture_fn,G__12290,G__12290__$1,env,once_fixtures,each_fixtures,vec__12287,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12290__$1)].join('')));

}
})());
});
;})(vec__12287,ns,vars__$1))
