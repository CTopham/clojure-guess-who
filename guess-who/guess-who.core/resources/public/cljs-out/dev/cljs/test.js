...
var G__12248 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__12248,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__12248;
}
});
...
var len__4730__auto___12253 = arguments.length;
var i__4731__auto___12254 = (0);
while(true){
if((i__4731__auto___12254 < len__4730__auto___12253)){
args__4736__auto__.push((arguments[i__4731__auto___12254]));

var G__12255 = (i__4731__auto___12254 + (1));
i__4731__auto___12254 = G__12255;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq12250){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12251,G__12252,seq12250__$2);
});
...
var file = cljs.core.get.call(null,map__12257__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__12257,map__12257__$1,file,line,column){
return (function (p1__12256_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__12256_SHARP_));
});})(map__12257,map__12257__$1,file,line,column))
...
var temp__5457__auto___12259 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___12259)){
var message_12260 = temp__5457__auto___12259;
cljs.core.println.call(null,message_12260);
} else {
}
...
var output_dir__$1 = (function (){var G__12263 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__12263,"/"].join('');
} else {
return G__12263;
}
})();
...
var G__12265 = exception.stack;
var G__12265__$1 = (((G__12265 == null))?null:clojure.string.split_lines.call(null,G__12265));
var G__12265__$2 = (((G__12265__$1 == null))?null:cljs.core.get.call(null,G__12265__$1,depth));
if((G__12265__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__12265__$2);
}
} else {
...
var vec__12266 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__12266,(0),null);
var column = cljs.core.nth.call(null,vec__12266,(1),null);
var vec__12269 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__12269,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__12269,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__12269,(2),null);
...
var m__$1 = (function (){var G__12272 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__12272__$1 = (((G__12272 instanceof cljs.core.Keyword))?G__12272.fqn:null);
switch (G__12272__$1) {
case "fail":
...
var G__12276 = (function (){var G__12275 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__12275);
} else {
return G__12275;
}
})();
...
return cljs.core.vary_meta.call(null,G__12277,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__12281 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__12281,(0),null);
var types = vec__12281;
...
return cljs.core.map.call(null,(function (p__12284){
var vec__12285 = p__12284;
var ns = cljs.core.nth.call(null,vec__12285,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__12285,(1),null);
return ((function (vec__12285,ns,vars__$1){
return (function (){
...
var G__12288 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__12288,G__12288__$1,env,once_fixtures,each_fixtures,vec__12285,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__12288,G__12288__$1,env,once_fixtures,each_fixtures,vec__12285,ns,vars__$1){
return (function (){
var seq__12289 = cljs.core.seq.call(null,vars__$1);
var chunk__12290 = null;
var count__12291 = (0);
var i__12292 = (0);
while(true){
if((i__12292 < count__12291)){
var v = cljs.core._nth.call(null,chunk__12290,i__12292);
var temp__5457__auto___12294 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___12294)){
var t_12295 = temp__5457__auto___12294;
each_fixture_fn.call(null,((function (seq__12289,chunk__12290,count__12291,i__12292,t_12295,temp__5457__auto___12294,v,each_fixture_fn,G__12288,G__12288__$1,env,once_fixtures,each_fixtures,vec__12285,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12295)));
});})(seq__12289,chunk__12290,count__12291,i__12292,t_12295,temp__5457__auto___12294,v,each_fixture_fn,G__12288,G__12288__$1,env,once_fixtures,each_fixtures,vec__12285,ns,vars__$1))
);
} else {
}


var G__12296 = seq__12289;
var G__12297 = chunk__12290;
var G__12298 = count__12291;
var G__12299 = (i__12292 + (1));
seq__12289 = G__12296;
chunk__12290 = G__12297;
count__12291 = G__12298;
i__12292 = G__12299;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__12289);
if(temp__5457__auto__){
var seq__12289__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__12289__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__12289__$1);
var G__12300 = cljs.core.chunk_rest.call(null,seq__12289__$1);
var G__12301 = c__4550__auto__;
var G__12302 = cljs.core.count.call(null,c__4550__auto__);
var G__12303 = (0);
seq__12289 = G__12300;
chunk__12290 = G__12301;
count__12291 = G__12302;
i__12292 = G__12303;
continue;
} else {
var v = cljs.core.first.call(null,seq__12289__$1);
var temp__5457__auto___12304__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___12304__$1)){
var t_12305 = temp__5457__auto___12304__$1;
each_fixture_fn.call(null,((function (seq__12289,chunk__12290,count__12291,i__12292,t_12305,temp__5457__auto___12304__$1,v,seq__12289__$1,temp__5457__auto__,each_fixture_fn,G__12288,G__12288__$1,env,once_fixtures,each_fixtures,vec__12285,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12305)));
});})(seq__12289,chunk__12290,count__12291,i__12292,t_12305,temp__5457__auto___12304__$1,v,seq__12289__$1,temp__5457__auto__,each_fixture_fn,G__12288,G__12288__$1,env,once_fixtures,each_fixtures,vec__12285,ns,vars__$1))
);
} else {
}


var G__12306 = cljs.core.next.call(null,seq__12289__$1);
var G__12307 = null;
var G__12308 = (0);
var G__12309 = (0);
seq__12289 = G__12306;
chunk__12290 = G__12307;
count__12291 = G__12308;
i__12292 = G__12309;
continue;
}
} else {
...
});})(each_fixture_fn,G__12288,G__12288__$1,env,once_fixtures,each_fixtures,vec__12285,ns,vars__$1))
);
});})(each_fixture_fn,G__12288,G__12288__$1,env,once_fixtures,each_fixtures,vec__12285,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12288__$1)].join('')));

}
})());
});
;})(vec__12285,ns,vars__$1))
