...
var G__12062 = o;
(G__12062[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__12064__i < G__12064__a.length) {G__12064__a[G__12064__i] = arguments[G__12064__i + 0]; ++G__12064__i;}
  args = new cljs.core.IndexedSeq(G__12064__a,0,null);
} 
...
var args = cljs.core.seq(arglist__12065);
...
var G__12066 = o;
(G__12066[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__12068__i < G__12068__a.length) {G__12068__a[G__12068__i] = arguments[G__12068__i + 0]; ++G__12068__i;}
  args = new cljs.core.IndexedSeq(G__12068__a,0,null);
} 
...
var G__12071 = props;
var G__12071__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__12071,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12071);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__12071__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__12072){
var map__12073 = p__12072;
var map__12073__$1 = (((((!((map__12073 == null))))?(((((map__12073.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12073.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12073):map__12073);
var props = map__12073__$1;
var class$ = cljs.core.get.call(null,map__12073__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__12073,map__12073__$1,props,class$){
return (function (c){
...
});})(map__12073,map__12073__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__12075){
var map__12076 = p__12075;
var map__12076__$1 = (((((!((map__12076 == null))))?(((((map__12076.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12076.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12076):map__12076);
var on_write = cljs.core.get.call(null,map__12076__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__12076,map__12076__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__12076,map__12076__$1,on_write))
);
} else {
...
var G__12079 = jsprops;
(G__12079["defaultValue"] = value);

(G__12079["onChange"] = ((function (G__12079,v,value,on_change){
return (function (p1__12078_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__12078_SHARP_);
});})(G__12079,v,value,on_change))
);
...
var vec__12082 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__12082,(0),null);
var id = cljs.core.nth.call(null,vec__12082,(1),null);
var class$ = cljs.core.nth.call(null,vec__12082,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___12086 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___12086 == null)){
} else {
var key_12087 = temp__5461__auto___12086;
(jsprops["key"] = key_12087);
}
...
var temp__5461__auto___12088 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___12088 == null)){
} else {
var key_12089 = temp__5461__auto___12088;
reagent.impl.template.oset.call(null,jsprops,"key",key_12089);
}
...
var G__12090 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__12090["name"] = c);
...
var G__12098 = (i__4731__auto___12097 + (1));
i__4731__auto___12097 = G__12098;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12094){
var G__12095 = cljs.core.first.call(null,seq12094);
var seq12094__$1 = cljs.core.next.call(null,seq12094);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12095,seq12094__$1);
});
...
break;
default:
var G__12101 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__12101;
continue;
...
var n__4607__auto___12103 = a.length;
var i_12104 = (0);
while(true){
if((i_12104 < n__4607__auto___12103)){
(a[i_12104] = reagent.impl.template.as_element.call(null,(a[i_12104])));
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___12106 = a.length;
var i_12107 = (0);
while(true){
if((i_12107 < n__4607__auto___12106)){
var val_12108 = (a[i_12107]);
if(((cljs.core.vector_QMARK_.call(null,val_12108)) && ((reagent.impl.template.key_from_vec.call(null,val_12108) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_12107] = reagent.impl.template.as_element.call(null,val_12108));

var G__12109 = (i_12107 + (1));
i_12107 = G__12109;
continue;
} else {
}
...
var ctx = ({});
var vec__12110 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__12110,(0),null);
var derefed = cljs.core.nth.call(null,vec__12110,(1),null);
...
var G__12113 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12113) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__12113){
