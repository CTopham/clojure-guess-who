...
if((i < len)){
var k = (ks[i]);
var G__11949 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__11950 = (i + (1));
m = G__11949;
i = G__11950;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__11952 = c;
var G__11952__$1 = (((G__11952 == null))?null:G__11952.prototype);
if((G__11952__$1 == null)){
return null;
} else {
return (G__11952__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__11954 = c;
var G__11954__$1 = (((G__11954 == null))?null:G__11954.prototype);
if((G__11954__$1 == null)){
return null;
} else {
return (G__11954__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__11957__delegate = function (args){
...
while (G__11958__i < G__11958__a.length) {G__11958__a[G__11958__i] = arguments[G__11958__i + 0]; ++G__11958__i;}
  args = new cljs.core.IndexedSeq(G__11958__a,0,null);
} 
return G__11957__delegate.call(this,args);};
...
return G__11957__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__11961 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11962 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11962;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11961;
}});
...
return ((function (G__11963,G__11963__$1){
...
var c = this;
var G__11968_11970 = (c["cljsRatom"]);
if((G__11968_11970 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__11968_11970);
}
...
var renders_11972 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_11973 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_11972));
if((cljs.core.count.call(null,renders_11972) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_11972))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_11973)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_11973)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__11971 = name;
switch (G__11971) {
case "":
...
var G__11975 = o;
(G__11975[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__11976 = fiber;
var G__11976__$1 = (((G__11976 == null))?null:(G__11976["type"]));
if((G__11976__$1 == null)){
return null;
} else {
return (G__11976__$1["displayName"]);
}
})();
var parent = (function (){var G__11977 = fiber;
if((G__11977 == null)){
return null;
} else {
return (G__11977["return"]);
}
})();
var path = (function (){var G__11978 = parent;
var G__11978__$1 = (((G__11978 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__11978));
if((G__11978__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11978__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__4131__auto__ = (function (){var G__11980 = c;
if((G__11980 == null)){
return null;
} else {
return (G__11980["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__11981._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__11983 = c;
if((G__11983 == null)){
return null;
} else {
return (G__11983["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__11985 = c;
if((G__11985 == null)){
return null;
} else {
return G__11985._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__11987 = instance;
if((G__11987 == null)){
return null;
} else {
return (G__11987["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__11988 = instance;
if((G__11988 == null)){
return null;
} else {
return G__11988._currentElement;
}
}
})();
var name = (function (){var G__11989 = elem;
var G__11989__$1 = (((G__11989 == null))?null:(G__11989["type"]));
if((G__11989__$1 == null)){
return null;
} else {
return (G__11989__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__11991 = elem;
if((G__11991 == null)){
return null;
} else {
return (G__11991["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__11992._owner;
}
}
})();
var path = (function (){var G__11993 = owner;
var G__11993__$1 = (((G__11993 == null))?null:reagent.impl.component.component_path.call(null,G__11993));
if((G__11993__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11993__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__11994 = c;
var G__11994__$1 = (((G__11994 == null))?null:G__11994.constructor);
if((G__11994__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__11994__$1);
}
}
})();
