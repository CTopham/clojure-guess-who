...
var G__13890 = devtools.prefs.pref.call(null,v);
v = G__13890;
continue;
} else {
return v;
...
}catch (e13893){var _e__12783__auto__ = e13893;
return false;
}})();
...
}catch (e13897){var _e__12783__auto__ = e13897;
return false;
}})();
...
}catch (e13899){var _e__12783__auto__ = e13899;
return false;
}}
}
});
...
var vec__13901 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__13901,(0),null);
var name = cljs.core.nth.call(null,vec__13901,(1),null);
...
return cljs.core.some.call(null,(function (p1__13904_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13904_SHARP_);
}),template);
});
