...
var G__13975 = devtools.prefs.pref.call(null,v);
v = G__13975;
continue;
} else {
return v;
...
}catch (e13978){var _e__12786__auto__ = e13978;
return false;
}})();
...
}catch (e13982){var _e__12786__auto__ = e13982;
return false;
}})();
...
}catch (e13984){var _e__12786__auto__ = e13984;
return false;
}}
}
});
...
var vec__13986 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__13986,(0),null);
var name = cljs.core.nth.call(null,vec__13986,(1),null);
...
return cljs.core.some.call(null,(function (p1__13989_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13989_SHARP_);
}),template);
});
