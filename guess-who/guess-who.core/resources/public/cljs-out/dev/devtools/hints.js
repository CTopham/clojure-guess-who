...
var map__18658 = top_item;
var map__18658__$1 = (((((!((map__18658 == null))))?(((((map__18658.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__18658.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__18658):map__18658);
var file = cljs.core.get.call(null,map__18658__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__18658__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__18658__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e18657){var _e = e18657;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___18660 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___18660)){
var seen_errors_18661 = temp__5455__auto___18660;
if(cljs.core.truth_(seen_errors_18661.has(self))){
} else {
seen_errors_18661.add(self);

var temp__5457__auto___18662 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___18662)){
var sense_18663 = temp__5457__auto___18662;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_18663)].join('');
} else {
}
}
} else {
